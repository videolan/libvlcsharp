...
namespace libvlcsharp
{
    ...
    public unsafe partial class DialogId
    {
        ...
        internal static readonly global::System.Collections.Concurrent.ConcurrentDictionary<IntPtr, global::libvlcsharp.DialogId> NativeToManagedMap = new global::System.Collections.Concurrent.ConcurrentDictionary<IntPtr, global::libvlcsharp.DialogId>();
        protected void*[] __OriginalVTables;

        protected bool __ownsNativeInstance;

        internal static global::libvlcsharp.DialogId __CreateInstance(global::System.IntPtr native, bool skipVTables = false)
        {
            return new global::libvlcsharp.DialogId(native.ToPointer(), skipVTables);
        }

        internal static global::libvlcsharp.DialogId __CreateInstance(global::libvlcsharp.DialogId.__Internal native, bool skipVTables = false)
        {
            return new global::libvlcsharp.DialogId(native, skipVTables);
        }

        private static void* __CopyValue(global::libvlcsharp.DialogId.__Internal native)
        {
            var ret = Marshal.AllocHGlobal(sizeof(global::libvlcsharp.DialogId.__Internal));
            *(global::libvlcsharp.DialogId.__Internal*) ret = native;
            return ret.ToPointer();
        }

        private DialogId(global::libvlcsharp.DialogId.__Internal native, bool skipVTables = false)
    ...
    public unsafe partial class DialogCallback : IDisposable
    {
        ...
        protected int __PointerAdjustment;
        internal static readonly global::System.Collections.Concurrent.ConcurrentDictionary<IntPtr, global::libvlcsharp.DialogCallback> NativeToManagedMap = new global::System.Collections.Concurrent.ConcurrentDictionary<IntPtr, global::libvlcsharp.DialogCallback>();
        protected void*[] __OriginalVTables;

        protected bool __ownsNativeInstance;

        internal static global::libvlcsharp.DialogCallback __CreateInstance(global::System.IntPtr native, bool skipVTables = false)
        {
            return new global::libvlcsharp.DialogCallback(native.ToPointer(), skipVTables);
        }

        internal static global::libvlcsharp.DialogCallback __CreateInstance(global::libvlcsharp.DialogCallback.__Internal native, bool skipVTables = false)
        {
            return new global::libvlcsharp.DialogCallback(native, skipVTables);
        }

        private static void* __CopyValue(global::libvlcsharp.DialogCallback.__Internal native)
        {
            var ret = Marshal.AllocHGlobal(sizeof(global::libvlcsharp.DialogCallback.__Internal));
            *(global::libvlcsharp.DialogCallback.__Internal*) ret = native;
            return ret.ToPointer();
        }

        private DialogCallback(global::libvlcsharp.DialogCallback.__Internal native, bool skipVTables = false)
            : this(__CopyValue(native), skipVTables)
        {
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
        ...
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::libvlcsharp.DialogCallback.__Internal));
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
        }

        public DialogCallback(global::libvlcsharp.DialogCallback _0)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::libvlcsharp.DialogCallback.__Internal));
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
            *((global::libvlcsharp.DialogCallback.__Internal*) __Instance) = *((global::libvlcsharp.DialogCallback.__Internal*) _0.__Instance);
        }
        ...
        public virtual void Dispose(bool disposing)
        {
            if (__Instance == IntPtr.Zero)
                return;
            global::libvlcsharp.DialogCallback __dummy;
    ...
    public unsafe partial class libvlc_dialog
    {
        ...
        public static void LibvlcDialogSetCallbacks(global::libvlcsharp.Instance p_instance, global::libvlcsharp.DialogCallback p_cbs, global::System.IntPtr p_data)
        {
        ...
        /// <remarks>LibVLC 3.0.0 and later.</remarks>
        public static void LibvlcDialogSetContext(global::libvlcsharp.DialogId p_id, global::System.IntPtr p_context)
        {
        ...
        /// <remarks>LibVLC 3.0.0 and later.</remarks>
        public static global::System.IntPtr LibvlcDialogGetContext(global::libvlcsharp.DialogId p_id)
        {
            var __arg0 = ReferenceEquals(p_id, null) ? global::System.IntPtr.Zero : p_id.__Instance;
        ...
        /// </remarks>
        public static int LibvlcDialogPostLogin(global::libvlcsharp.DialogId p_id, string psz_username, string psz_password, bool b_store)
        {
            var __arg0 = ReferenceEquals(p_id, null) ? global::System.IntPtr.Zero : p_id.__Instance;
        ...
        /// <para>LibVLC 3.0.0 and later.</para>
        /// </remarks>
        public static int LibvlcDialogPostAction(global::libvlcsharp.DialogId p_id, int i_action)
        {
            var __arg0 = ReferenceEquals(p_id, null) ? global::System.IntPtr.Zero : p_id.__Instance;
        ...
        /// <para>LibVLC 3.0.0 and later.</para>
        /// </remarks>
        public static int LibvlcDialogDismiss(global::libvlcsharp.DialogId p_id)
        {
            var __arg0 = ReferenceEquals(p_id, null) ? global::System.IntPtr.Zero : p_id.__Instance;
