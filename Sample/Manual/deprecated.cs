...
namespace libvlcsharp
{
    ...
    public unsafe partial class LogIterator
    {
        ...
        private static void* __CopyValue(global::libvlcsharp.LogIterator.__Internal native)
        {
            var ret = Marshal.AllocHGlobal(sizeof(global::libvlcsharp.LogIterator.__Internal));
            *(global::libvlcsharp.LogIterator.__Internal*) ret = native;
            return ret.ToPointer();
        }

        private LogIterator(global::libvlcsharp.LogIterator.__Internal native, bool skipVTables = false)
    ...
    public unsafe partial class LogMessage : IDisposable
    {
        ...
        private static void* __CopyValue(global::libvlcsharp.LogMessage.__Internal native)
        {
            var ret = Marshal.AllocHGlobal(sizeof(global::libvlcsharp.LogMessage.__Internal));
            *(global::libvlcsharp.LogMessage.__Internal*) ret = native;
            return ret.ToPointer();
        }

        private LogMessage(global::libvlcsharp.LogMessage.__Internal native, bool skipVTables = false)
            : this(__CopyValue(native), skipVTables)
        {
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
        ...
        public LogMessage(global::libvlcsharp.LogMessage _0)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::libvlcsharp.LogMessage.__Internal));
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
        ...
        public virtual void Dispose(bool disposing)
        {
            if (__Instance == IntPtr.Zero)
                return;
            global::libvlcsharp.LogMessage __dummy;
        ...
        public string PszHeader
        {
            get
            {
                return Marshal.PtrToStringAnsi(((global::libvlcsharp.LogMessage.__Internal*) __Instance)->psz_header);
            }
        ...
        public string PszMessage
        {
            get
            {
                return Marshal.PtrToStringAnsi(((global::libvlcsharp.LogMessage.__Internal*) __Instance)->psz_message);
            }
    ...
    public unsafe partial class deprecated
    {
        ...
        public static global::libvlcsharp.LogIterator LibvlcLogGetIterator(global::libvlcsharp.Log p_log)
        {
            var __arg0 = ReferenceEquals(p_log, null) ? global::System.IntPtr.Zero : p_log.__Instance;
            var __ret = __Internal.LibvlcLogGetIterator(__arg0);
            global::libvlcsharp.LogIterator __result0;
            if (__ret == IntPtr.Zero) __result0 = null;
            else if (global::libvlcsharp.LogIterator.NativeToManagedMap.ContainsKey(__ret))
                __result0 = (global::libvlcsharp.LogIterator) global::libvlcsharp.LogIterator.NativeToManagedMap[__ret];
            else __result0 = global::libvlcsharp.LogIterator.__CreateInstance(__ret);
            return __result0;
        }

        /// <summary>Frees memory allocated by libvlc_log_get_iterator().</summary>
        /// <param name="p_iter">libvlc log iterator or NULL</param>
        public static void LibvlcLogIteratorFree(global::libvlcsharp.LogIterator p_iter)
        {
        ...
        /// <returns>always zero</returns>
        public static int LibvlcLogIteratorHasNext(global::libvlcsharp.LogIterator p_iter)
        {
            var __arg0 = ReferenceEquals(p_iter, null) ? global::System.IntPtr.Zero : p_iter.__Instance;
            ...
            global::libvlcsharp.LogMessage p_buf)
        {
            ...
            global::libvlcsharp.LogMessage __result0;
            if (__ret == IntPtr.Zero) __result0 = null;
            else if (global::libvlcsharp.LogMessage.NativeToManagedMap.ContainsKey(__ret))
                __result0 = (global::libvlcsharp.LogMessage) global::libvlcsharp.LogMessage.NativeToManagedMap[__ret];
            else __result0 = global::libvlcsharp.LogMessage.__CreateInstance(__ret);
            return __result0;
        }
