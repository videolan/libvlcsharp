...
namespace LibVLCSharp
{
    ...
    public class MediaPlayer : Internal
    {
        ...
        /// </param>
        /// <param name="report_opaque">private pointer to pass to the <see cref="OutputResize"/> callback.</param>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void SetWindow(IntPtr opaque, OutputResize reportSizeChange, MouseMove mouseMove, MousePress mousePress, MouseRelease mouseRelease, IntPtr report_opaque);
        ...
        /// </summary>
        /// <param name="report_opaque">opaque pointer passed to <see cref="SetWindow"/></param>
        /// <param name="width">new rendering width requested</param>
        /// <param name="height">new rendering height requested</param>
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void OutputResize(IntPtr report_opaque, uint width, uint height);
