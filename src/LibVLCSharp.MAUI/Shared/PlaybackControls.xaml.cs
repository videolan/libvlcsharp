...
namespace LibVLCSharp.MAUI.Shared
{
    ...
    public partial class PlaybackControls : TemplatedView
    {
        ...
        private ImageButton? PlayPauseButton { get; set; }
        ...
        private ImageButton? SetClickEventHandler(string name, EventHandler eventHandler, bool fadeIn = false)
        {
            var button = this.FindChild<ImageButton>(name);
            if (button != null)
            {
        ...
        private void UpdateTracksSelectionButtonAvailability(ImageButton? tracksSelectionButton, string state)
        {
        ...
        private void UpdateTracksSelectionAvailability(TracksManager tracksManager, ImageButton? tracksSelectionButton,
